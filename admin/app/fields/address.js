...
export const address = {
    ...
    fields: [
        ...
        { 
            ...
            collapsed: true,
            fields: [
                { name: 'lat', label: t.fields.address.fields.lat, widget: 'number', value_type: 'int', required: false },
                { name: 'lng', label: t.fields.address.fields.lng, widget: 'number', value_type: 'int', required: false },
            ]
        }
    ]
}